...
class StationInfoPageKeyedDataSource(
...
) : PageKeyedDataSource<Int, StationInfo.StationInfoItem>(), KoinComponent {
    ...
    override fun loadInitial(
        ...
        callback: LoadInitialCallback<Int, StationInfo.StationInfoItem>
    ) {
    ...
    override fun loadAfter(
        ...
        callback: LoadCallback<Int, StationInfo.StationInfoItem>
    ) {
